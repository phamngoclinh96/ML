...
class EntityLSTM(object):
    ...
    def __init__(self, dataset,token_embedding_dimension,character_lstm_hidden_state_dimension,token_lstm_hidden_state_dimension,character_embedding_dimension,
                 use_crf=True,use_character_lstm=True,freeze_token_embeddings=False,
    ...
    def load_pretrained_token_embeddings(self, sess, dataset,embedding_filepath='', token_to_vector=None,check_lowercase=True,check_digits=True):
