...
class NeuroNER(object):
    ...
    def __init__(self,
        ...
        with sess.as_default():
            ...
            if not parameters['use_pretrained_model']:
                ...
                self.transition_params_trained = model.restore_from_pretrained_model(dataset, sess , model_pathfile=os.path.join(parameters['pretrained_model_folder'],'model.ckpt'),
    ...
    def predict(self, text):
        ...
        conll2brat.output_brat(output_filepaths, self.dataset_brat_folders, self.stats_graph_folder, overwrite=True)
